...
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, email, password, existingUser, hashedPassword, newUser, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                // Save the user to the database
                _b.sent();
                token = jsonwebtoken_1.default.sign({ userId: newUser._id }, 'your-secret-key', { expiresIn: '1h' });
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                token = jsonwebtoken_1.default.sign({ userId: user._id }, 'your-secret-key', { expiresIn: '1h' });
